...
class ChildFrame(tk.Toplevel): #Создание окна для заполнения данных в таблицу 
    def __init__(self):
        super().__init__(root)
        self.title("Добавить")
...
class UpdateEmployeeDataFrame(ChildFrame): #Создание окна для редактирования данных пользователей внесенных в таблицу 
    def __init__(self):
        super().__init__()
        self.init_edit()
        self.view = app
...
class SearchEmployeeFrame(tk.Toplevel): #Создание окна для поиска сотрудников по имени, а также обработка данного действия 
    def __init__(self):
        super().__init__()
        self.init_search()
        self.view = app
